...
class ManageTypeMeuleCuController extends AbstractController
{
    /**
     * This method process forms TypeMeuleCuType
     * 
     * @Route("/update/{nameCu}/type-meule/{id}", name="update_typeMeule")
     */
     ...
     */
    public function deleteTypMeule(TypeMeuleCuRepository $typeMeuleCuRepository, 
        MeuleCuRepository $meuleCuRepository, $nameCu, $id
    ) : Response {
