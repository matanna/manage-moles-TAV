 ...
 */
final class Version20210614133401 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE meule_cu ADD CONSTRAINT FK_F5C8DC14670C757F FOREIGN KEY (fournisseur_id) REFERENCES fournisseur (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
        $this->addSql('ALTER TABLE meule_cu ADD CONSTRAINT FK_F5C8DC148E45D969 FOREIGN KEY (type_meule_cu_id) REFERENCES type_meule_cu (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
        $this->addSql('ALTER TABLE meules_recti ADD CONSTRAINT FK_4489D73D670C757F FOREIGN KEY (fournisseur_id) REFERENCES fournisseur (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
        ...
        $this->addSql('ALTER TABLE type_meule_cu ADD CONSTRAINT FK_3837FBE8DD51B60C FOREIGN KEY (cu_id) REFERENCES cu (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
        ...
        $this->addSql('ALTER TABLE position ADD CONSTRAINT FK_462CE4F5F6B75B26 FOREIGN KEY (machine_id) REFERENCES machine (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
