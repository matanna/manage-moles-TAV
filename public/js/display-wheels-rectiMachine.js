...
$(document).ready(function() {
    ...
    $('#display-wheels-rectiMachine').children().remove();
                ...
                for (let wheels in data) {
                    ...
                    if (data[wheels]['wheels']['stock'] > 0) {
                        ...
                        html = html + '<div class="row text-center pt-2 pb-2 wheels-rectiMachine" id="wheels-rectiMachine-' + data[wheels]['wheels']['id'] + '">\
                                      <div class="col-1 text-uppercase">' + data[wheels]['wheels']['position']['rectiMachine']['name'] + '</div>\
                                      <div class="col-1">' + data[wheels]['wheels']['position']['name'] + '</div>\
